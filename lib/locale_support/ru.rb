require 'locale_support/ru/transliteration'
require 'locale_support/ru/action_view_ext/helpers/date_helper'
...
module LocaleSupport
  module Ru
    ...
    #
    # Usage: 
    #   LocaleSupport::Ru.pluralize(1, "вещь", "вещи", "вещей")
    #   LocaleSupport::Ru.pluralize(3.14, "вещь", "вещи", "вещей", "вещи")
    ...
    #
    # Usage:
    #  LocaleSupport::Ru.translit("рубин")
    #  LocaleSupport::Ru.transliterate("рубин")
    def transliterate(str)
      Ru::Transliteration.transliterate(str)
    end
    ...
    protected
      ...
      def locale_files
        Dir[File.join(File.dirname(__FILE__), "ru", "locale", "**/*")]
      end
